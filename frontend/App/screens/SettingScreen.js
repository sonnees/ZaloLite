    ...
    <View style={styles.container}>
      ...
      <View style={{flex: 15.75}}>
        <View style={{flex: 0.75, backgroundColor: "#FFFFFF", flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
          <Image style={{width: "15%", height: "40%", resizeMode: "center", marginLeft: "-6%"}} source={require("../assets/shield.png")}></Image>
          <View style={{flex: 0.01}}></View>
          <View style={{justifyContent: "center"}}>
            <Text style={{fontFamily: "Roboto", fontSize: 15 }}>Tài khoản và bảo mật</Text>
          </View>
          <View style={{flex: 0.75}}></View>
          <Image style={{width: "10%", height: "25%", resizeMode: "center"}} source={require("../assets/next.png")}></Image>
        </View>
        <View style={{flex: 0.02}}></View>

        
        <View style={{flex: 0.75, backgroundColor: "#FFFFFF", flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
          <Image style={{width: "15%", height: "40%", resizeMode: "center", marginLeft: "-6.9%"}} source={require("../assets/lock.png")}></Image>
          <View style={{flex: 0.01}}></View>
          <View style={{justifyContent: "center"}}>
            <Text style={{fontFamily: "Roboto", fontSize: 15 }}>Quyền riêng tư</Text>
          </View>
          <View style={{flex: 0.75}}></View>
          <Image style={{width: "10%", height: "25%", resizeMode: "center", marginRight:"-1%"}} source={require("../assets/next.png")}></Image>
        </View>
        <View style={{flex: 0.05}}></View>

        
        <View style={{flex: 0.75, backgroundColor: "#FFFFFF", flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
          <Image style={{width: "15%", height: "40%", resizeMode: "center", marginLeft: "-4%"}} source={require("../assets/pie.png")}></Image>
          <View style={{flex: 0.01}}></View>
          <View style={{justifyContent: "center"}}>
        ...
        <View style={{flex: 0.75, backgroundColor: "#FFFFFF", flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
          ...
          <View style={{flex: 0.75}}></View>
          <Image style={{width: "10%", height: "25%", resizeMode: "center", marginRight:"4.5%"}} source={require("../assets/next.png")}></Image>
        </View>
        <View style={{flex: 0.05}}></View>

        <View style={{flex: 0.75, backgroundColor: "#FFFFFF", flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
          <Image style={{width: "15%", height: "40%", resizeMode: "center", marginLeft: "-6%"}} source={require("../assets/bell1.png")}></Image>
          <View style={{flex: 0.01}}></View>
          <View style={{justifyContent: "center"}}>
            <Text style={{fontFamily: "Roboto", fontSize: 15 }}>Thông báo</Text>
          </View>
          <View style={{flex: 0.75}}></View>
          <Image style={{width: "10%", height: "25%", resizeMode: "center", marginRight: "-2%"}} source={require("../assets/next.png")}></Image>
        </View>
        <View style={{flex: 0.02}}></View>

        <View style={{flex: 0.75, backgroundColor: "#FFFFFF", flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
          <Image style={{width: "15%", height: "40%", resizeMode: "center", marginLeft: "-6%"}} source={require("../assets/chat.png")}></Image>
          <View style={{flex: 0.01}}></View>
          <View style={{justifyContent: "center"}}>
        ...
        <View style={{flex: 0.75, backgroundColor: "#FFFFFF", flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
          <Image style={{width: "15%", height: "40%", resizeMode: "center", marginLeft: "-6%"}} source={require("../assets/telephone.png")}></Image>
          <View style={{flex: 0.01}}></View>
          <View style={{justifyContent: "center"}}>
        ...
        <View style={{flex: 0.75, backgroundColor: "#FFFFFF", flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
          <Image styl e={{width: "15%", height: "40%", resizeMode: "center", marginLeft: "-6%"}} source={require("../assets/wall-clock.png")}></Image>
          <View style={{flex: 0.01}}></View>
          <View style={{justifyContent: "center"}}>
        ...
        <View style={{flex: 0.75, backgroundColor: "#FFFFFF", flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
          <Image style={{width: "15%", height: "100%", resizeMode: "center", marginLeft: "-6%"}} source={require("../assets/book.png")}></Image>
          <View style={{flex: 0.01}}></View>
          <View style={{justifyContent: "center"}}>
        ...
        <View style={{flex: 0.75, backgroundColor: "#FFFFFF", flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
          <Image style={{width: "15%", height: "40%", resizeMode: "center", marginLeft: "-1.5%"}} source={require("../assets/paintbrush.png")}></Image>
          <View style={{flex: 0.01}}></View>
          <View style={{justifyContent: "center"}}>
        ...
        >
          <Image style={{width: "15%", height: "100%", resizeMode: "center", marginLeft: "-5%"}} source={require("../assets/transfer.png")}></Image>
          <View style={{flex: 0.01}}></View>
          <View style={{justifyContent: "center"}}>
            <Text style={{fontFamily: "Roboto", fontSize: 15 }}>Chuyển tài khoản</Text>
          </View>
          <View style={{flex: 0.75}}></View>
          <Image style={{width: "10%", height: "25%", resizeMode: "center", marginRight: "-0.4%"}} source={require("../assets/next.png")}></Image>
        </View>
        <View style={{flex: 0.02}}></View>
